...
public class jFrmVentana extends javax.swing.JFrame {
    ...
    private void loadMaps() {
        ...
        mapa.insertMapa("Mapa0", 1100, 350, -500, 146, -500, 146, 0, -500, "", fondo, 1100, 250);
        fondo = new ImageIcon(".\\src\\Fondos\\Fondo1.png");
        mapa.insertMapa("Mapa1", 60, 154, 500, 146, 1000, 146, -0, -500, "", fondo, 100, 60);
        mapa.insertMapa("Mapa2", 60, 154, -500, -50, -500, -50, 136, 1000, "Boss1", fondo, 100, 60);
        fondo = new ImageIcon(".\\src\\Fondos\\Fondo2.png");
        mapa.insertMapa("Mapa3", 100, 310, 500, 310, 1000, 310, -0, -500, "", fondo, 100, 210);
        mapa.insertMapa("Mapa4", 100, 310, -500, -50, -500, -50, 310, 1000, "Boss2", fondo, 100, 210);
        fondo = new ImageIcon(".\\src\\Fondos\\Fondo3.png");
        mapa.insertMapa("Mapa5", 100, 360, 500, 360, 1000, 360, -0, -500, "", fondo, 100, 270);
        mapa.insertMapa("Mapa6", 100, 360, -500, -50, -500, -50, 360, 1000, "Boss3", fondo, 100, 270);
    }
